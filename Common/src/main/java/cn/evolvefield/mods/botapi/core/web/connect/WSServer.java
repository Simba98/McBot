package cn.evolvefield.mods.botapi.core.web.connect;
...
public class WSServer extends WebSocketServer {
    ...
    public void onMessage(WebSocket conn, String message) {
        ...
        var request = (Request) GsonUtil.fromJson(message, new TypeToken<Request>() {}.getType());
        log.info(request.toString());
        var event = new EventHandler(server, conn, request);
        event.run();
