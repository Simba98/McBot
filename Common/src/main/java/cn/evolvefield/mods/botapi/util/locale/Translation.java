...
public abstract class Translation {
    ...
    private static volatile Translation instance = loadDefault(Constants.config.getCommon().getLanguageSelect());
    ...
    private static Translation loadDefault(String langId) {
        ...
        try {
            ...
            if (inputStream == null) {
                Constants.LOGGER.info(String.format("No BotApi lang file for the language '%s' found. Make it to 'en_us' by default.", langId));
            ...
            Constants.LOGGER.error("Couldn't read strings from {}", resourceLocation, var8);
        }
