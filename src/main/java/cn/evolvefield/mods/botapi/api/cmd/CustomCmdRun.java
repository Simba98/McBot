...
public class CustomCmdRun extends CommandSourceStack {
    ...
    public static CustomCmdRun CUSTOM = new CustomCmdRun(CommandSource.NULL, Vec3.ZERO, Vec2.ZERO, BotApi.SERVER.overworld(), 4,
            "Bot", new TextComponent("Bot"), BotApi.SERVER, null);
