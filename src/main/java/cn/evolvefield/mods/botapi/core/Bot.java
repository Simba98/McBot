...
import cn.evolvefield.mods.botapi.model.action.common.*;
import cn.evolvefield.mods.botapi.model.action.response.*;
...
public class Bot {
     ...
     */
    public Bot(long selfId, Session session, ActionHandler actionHandler) {
        this.selfId = selfId;
     ...
     * 发送消息
     *
     * @param event      {@link GroupMessage}
     * @param msg        要发送的内容
     * @param autoEscape 消息内容是否作为纯文本发送 ( 即不解析 CQ 码 ) , 只在 message 字段是字符串时有效
     * @return {@link ActionData} of {@link MsgId}
     */
    public ActionData<MsgId> sendMsg(GroupMessage event, String msg, boolean autoEscape) {
    ...
    public ActionData<MsgId> sendPrivateMsg(long userId, String msg, boolean autoEscape) {
        ...
        var result = actionHandler.action(session, action, params);
    ...
    public ActionData<GuildServiceProfileResp> getGuildServiceProfile() {
        ...
        var result = actionHandler.action(session, action, null);
     ...
     * @return {@link ActionRaw}
     */
    public ActionRaw setGroupAnonymousBan(long groupId, GroupMessage.Anonymous anonymous, boolean duration) {
     ...
     * @return {@link ActionRaw}
     */
    public ActionData<MsgId> sendForwardMsg(GroupMessage event, List<Map<String, Object>> msg) {
